...
public interface KstoreMapper {
	 ...
	 * @return
	 */
	@Insert("insert into np_sell_area(sell_id,sell_name,sell_tell,sell_address,sell_remark,province_id,city_id) values(#{sellarea.sellId},#{sellarea.sellName},#{sellarea.sellTell},#{sellarea.sellAddress},#{sellarea.sellRemark},#{sellarea.provinceId},#{sellarea.cityId})")
